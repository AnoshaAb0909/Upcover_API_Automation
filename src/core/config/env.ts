...
export const env = {
  ...
  coalitionPaymentMethodId:
    process.env.COALITION_PAYMENT_METHOD_ID ?? 'pm_1RtRLPBO4MJdSb3sdPThpz5S',
  coalitionMonthlyPaymentMethodId:
    process.env.COALITION_MONTHLY_PAYMENT_METHOD_ID ??
    'pm_1Tqaf2F2zGZ7yHRLmSBiiKkq',
  ...
  vizPaymentMethodId:
    process.env.VIZ_PAYMENT_METHOD_ID ?? 'pm_1RecGkLLASrRQEGQSlvLq9sF',
  vizMonthlyPaymentMethodId:
    process.env.VIZ_MONTHLY_PAYMENT_METHOD_ID ?? 'pm_1RkiSMF2zGZ7yHRLhXSUJ1NY',
